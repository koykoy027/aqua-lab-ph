...
class PdfController extends Controller
{
    public function generateAnalysisPdf($analysis_id){
        ...
        $pdf = Pdf::loadView('record_and_report.analysis_request.pdf', ['details' =>  $details, 'micro_details' =>  $micro_details, 'collection_details' => $collection_details, 'clients' => $clients, 'labAcceptance' => $labAcceptance])->setPaper([0, 0, 612, 1008], 'portrait');
