...
@section('content')
    ...
    <div class="mb-3 bg-white card">
        ...
        <div class="flex justify-between">
            ...
            <div>
                {{-- <a target="_blank" title="Generate COA REPORTS" href="{{ route('record-and-report.analysis-request.generateAnalysisPdf', ['analysis_id' => $details->analysis_id]) }}" class="font-medium text-blue-600 hover:underline">
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-3">
            <div class="mb-3">
                ...
                <input id="sample_id" type="text" name="sample_id" value="{{ $details->labAcceptance->sample_id }}" readonly
    ...
    <div class="mb-3 bg-white card">
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
            <div class="mb-3">
                ...
                <input name="test_parameters_code" id="test_parameters_code" value="{{ $details->test_parameters_code }}" readonly
