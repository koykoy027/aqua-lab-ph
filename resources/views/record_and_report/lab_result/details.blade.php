...
<div class="bg-white card">
    <div class="flex justify-between">
        <div>
            <button class="text-blue-500 border-b-2 border-blue-500 btn category-button"
                onclick="categoryClientInformation()">Client Information</button>
        ...
        <div>
            {{-- <a target="_blank" title="Generate COA REPORTS" " class="font-medium text-blue-600  hover:underline">
            ...
            <a target="_blank" title="Generate COA REPORTS"
                href="{{ route('record-and-report.analysis-request.generateAnalysisPdf', ['analysis_id' => $analysis->analysis_id]) }}"
    ...
    <div class="hidden category categoryAnalysisRequest">
        @include('record_and_report.lab_result.partials.analysis_request')
    </div>

    <div class="hidden category categoryLabAcceptance">
