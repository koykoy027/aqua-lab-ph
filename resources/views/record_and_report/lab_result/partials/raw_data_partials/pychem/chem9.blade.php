        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            @foreach ($chem9 as $chem9s)
                ...
                <div class="mb-3">
                    ...
                    <input id="chem9_average_instrument_reading" type="text" name="chem9_average_instrument_reading" value="{{ $chem9s->chem9_average_instrument_reading }}" readonly autofocus autocomplete="chem9_average_instrument_reading" readonly>
                </div>
