    ...
    <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
        @foreach ($chem10 as $chem10s)
            <div class="mb-3">
                ...
                <input id="chem10_instrument_reading_1" type="number" name="chem10_instrument_reading_1" value="{{ $chem10s->chem10_instrument_reading_1 }}" required autofocus autocomplete="chem10_instrument_reading_1">
            </div>

            <div class="mb-3">
                <label for="chem10_instrument_reading_2">Instrument Reading 2</label>
                <input id="chem10_instrument_reading_2" type="number" name="chem10_instrument_reading_2" value="{{ $chem10s->chem10_instrument_reading_2 }}" required autofocus autocomplete="chem10_instrument_reading_2">
            </div>

            <div class="mb-3">
                <label for="chem10_instrument_reading_3">Instrument Reading 3</label>
                <input id="chem10_instrument_reading_3" type="number" name="chem10_instrument_reading_3" value="{{ $chem10s->chem10_instrument_reading_3 }}" required autofocus autocomplete="chem10_instrument_reading_3">
            </div>
            ...
            <div class="mb-3">
                ...
                <input id="chem10_final_result" type="number" name="chem10_final_result" value="{{ $chem10s->chem10_final_result }}" required autofocus autocomplete="chem10_final_result">
            </div>
