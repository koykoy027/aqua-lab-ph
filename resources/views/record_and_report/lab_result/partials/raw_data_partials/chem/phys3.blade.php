    ...
    <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
        @foreach ($phys3 as $phys3s)
            <div class="mb-3">
                ...
                <input id="phys3_concentration_of_comparable_color_standard" type="text" name="phys3_concentration_of_comparable_color_standard" value="{{ $phys3s->phys3_concentration_of_comparable_color_standard }}" required autofocus autocomplete="phys3_final_result" readonly>
