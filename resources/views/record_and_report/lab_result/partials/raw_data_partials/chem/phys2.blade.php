    ...
    <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
        @foreach ($phys2 as $phys2s)
            <div class="mb-3">
                ...
                <input id="phys2_observation" type="text" name="phys2_observation" value="{{ $phys2s->phys2_observation }}" required autofocus autocomplete="phys2_final_result" readonly>
