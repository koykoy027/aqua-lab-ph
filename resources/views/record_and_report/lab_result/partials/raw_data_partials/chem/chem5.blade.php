        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            @foreach ($chem5 as $chem5s)
                <div class="mb-3">
                    ...
                    <input id="chem5_instrument_reading_1" type="number" name="chem5_instrument_reading_1" value="{{ $chem5s->chem5_instrument_reading_1 }}" required autofocus autocomplete="chem5_instrument_reading_1">
                </div>

                <div class="mb-3">
                    <label for="chem5_instrument_reading_2">Instrument Reading 2</label>
                    <input id="chem5_instrument_reading_2" type="number" name="chem5_instrument_reading_2" value="{{ $chem5s->chem5_instrument_reading_2 }}" required autofocus autocomplete="chem5_instrument_reading_2">
                </div>

                <div class="mb-3">
                    <label for="chem5_instrument_reading_3">Instrument Reading 3</label>
                    <input id="chem5_instrument_reading_3" type="number" name="chem5_instrument_reading_3" value="{{ $chem5s->chem5_instrument_reading_3 }}" required autofocus autocomplete="chem5_instrument_reading_3">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input id="chem5_final_result" type="number" name="chem5_final_result" value="{{ $chem5s->chem5_final_result }}" required autofocus autocomplete="chem5_final_result">
                </div>
