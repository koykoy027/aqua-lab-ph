        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            @foreach ($chem9 as $chem9s)
                <div class="mb-3">
                    ...
                    <input id="chem9_instrument_reading_1" type="number" name="chem9_instrument_reading_1" value="{{ $chem9s->chem9_instrument_reading_1 }}" required autofocus autocomplete="chem9_instrument_reading_1">
                </div>

                <div class="mb-3">
                    <label for="chem9_instrument_reading_2">Instrument Reading 2</label>
                    <input id="chem9_instrument_reading_2" type="number" name="chem9_instrument_reading_2" value="{{ $chem9s->chem9_instrument_reading_2 }}" required autofocus autocomplete="chem9_instrument_reading_2">
                </div>

                <div class="mb-3">
                    <label for="chem9_instrument_reading_3">Instrument Reading 3</label>
                    <input id="chem9_instrument_reading_3" type="number" name="chem9_instrument_reading_3" value="{{ $chem9s->chem9_instrument_reading_3 }}" required autofocus autocomplete="chem9_instrument_reading_3">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input id="chem9_final_result" type="number" name="chem9_final_result" value="{{ $chem9s->chem9_final_result }}" required autofocus autocomplete="chem9_final_result">
                </div>
