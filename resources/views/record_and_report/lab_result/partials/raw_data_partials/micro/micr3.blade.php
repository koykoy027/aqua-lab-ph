    ...
    <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
        @foreach ($micro3 as $micro3s)
            <div class="mb-3">
                ...
                <input id="micr3_lauryl_24" type="text" name="micr3_lauryl_24" value="{{ $micro3s->micr3_lauryl_24 }}"
                    required autofocus autocomplete="micr3_lauryl_24" readonly>
            </div>
            ...
            <div class="mb-3">
                ...
                <input id="micr3_lauryl_48" type="text" name="micr3_lauryl_48"
                    value="{{ $micro3s->micr3_lauryl_48 }}" required autofocus autocomplete="micr3_lauryl_48" readonly>
            </div>
            ...
            <div class="mb-3">
                ...
                <input id="micr3_final_result" type="text" name="micr3_final_result"
                    value="{{ $micro3s->micr3_final_result }}" required autofocus autocomplete="micr3_final_result"
                    readonly>
            </div>
            ...
            <div class="mb-3">
                ...
                <input id="micr3_remarks" type="text" name="micr3_remarks" value="{{ $micro3s->micr3_remarks }}"
                    required autofocus autocomplete="micr3_remarks" readonly>
            </div>
        @endforeach
    </div>
