            ...
            <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
                ...
                <div class="mb-3">
                    ...
                    <input id="micr1_hpc_average" type="text" name="micr1_hpc_average"
                        value="{{ $rawData->micr1_hpc_average }}" required autofocus autocomplete="micr1_hpc_average"
                        readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input id="micr1_hpc_difference" type="text" name="micr1_hpc_difference"
                        value="{{ $rawData->micr1_hpc_difference }}" required autofocus
                ...
                <div class="mb-3">
                    ...
                    <input id="micr1_hpc_final_result" type="text" name="micr1_hpc_final_result"
                        value="{{ $rawData->micr1_hpc_final_result }}" required autofocus
                ...
                <div class="mb-3">
                    ...
                    <input id="micr1_hpc_remarks" type="text" name="micr1_hpc_remarks"
                        value="{{ $rawData->micr1_hpc_remarks }}" required autofocus autocomplete="micr1_hpc_remarks"
                        readonly>
                </div>
            </div>
        </div>
            ...
            <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
                ...
                <div class="mb-3">
                    ...
                    <input id="micr2_tc_final_result" type="text" name="micr2_tc_final_result"
                        value="{{ $rawData->micr2_tc_final_result }}" required autofocus
                ...
                <div class="mb-3">
                    ...
                    <input id="micr2_tc_remarks" type="text" name="micr2_tc_remarks"
                        value="{{ $rawData->micr2_tc_remarks }}" required autofocus autocomplete="micr2_tc_remarks"
                        readonly>
                </div>
            </div>
        </div>
            ...
            <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
                ...
                <div class="mb-3">
                    ...
                    <input id="micr3_final_result" type="text" name="micr3_final_result"
                        value="{{ $rawData->micr3_final_result }}" required autofocus
                ...
                <div class="mb-3">
                    ...
                    <input id="micr3_remarks" type="text" name="micr3_remarks"
                        value="{{ $rawData->micr3_remarks }}" required autofocus autocomplete="micr3_remarks"
                        readonly>
                </div>
            </div>
        ...
        <div class="card mb-3 bg-white">
            ...
            <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
                ...
                <div class="mb-3">
                    <label for="micr1_hpc_average">Average Colony Count</label>
                    <input id="micr1_hpc_average" type="text" name="micr1_hpc_average"
                        value="{{ $rawData->micr1_hpc_average }}" required autofocus
                ...
                <div class="mb-3">
                    <label for="micr1_hpc_remarks">Remarks</label>
                    <input id="micr1_hpc_remarks" type="text" name="micr1_hpc_remarks"
                        value="{{ $rawData->micr1_hpc_remarks }}" required autofocus
