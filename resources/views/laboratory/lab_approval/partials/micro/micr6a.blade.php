    ...
    <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
        <div class="mb-3">
            ...
            <input id="micro6a_hpc_plate_a" type="number" step="any" min="0" max="100000" name="micro6a_hpc_plate_a"
                value="{{ $micro6a->micro6a_hpc_plate_a }}" readonly autofocus autocomplete="micro6a_hpc_plate_a"
                onchange="micro6a()">
        ...
        <div class="mb-3">
            ...
            <input id="micro6a_hpc_plate_b" type="number" step="any" min="0" max="100000" name="micro6a_hpc_plate_b"
                value="{{ $micro6a->micro6a_hpc_plate_b }}" readonly autofocus autocomplete="micro6a_hpc_plate_b"
                onchange="micro6a()">
        ...
        <div class="mb-3">
            ...
            <input id="micro6a_hpc_average" type="text" name="micro6a_hpc_average"
                value="{{ $micro6a->micro6a_hpc_average }}" readonly autofocus autocomplete="micro6a_hpc_average"
                readonly>
        ...
        <div class="mb-3">
            ...
            <input id="micro6a_hpc_final_result" type="text" name="micro6a_hpc_final_result"
                value="{{ $micro6a->micro6a_hpc_final_result }}" readonly autofocus
        ...
        <div class="mb-3">
            ...
            <input id="micro6a_hpc_remarks" type="text" name="micro6a_hpc_remarks"
                value="{{ $micro6a->micro6a_hpc_remarks }}" readonly autofocus autocomplete="micro6a_hpc_remarks"
                readonly>
