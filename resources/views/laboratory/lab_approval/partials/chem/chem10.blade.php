<div class="card mb-3 bg-white">
    ...
    <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
        ...
        <div class="mb-3">
            ...
            <input id="chem10_average_instrument_reading" type="text" name="chem10_average_instrument_reading" value="{{ $chem10s->chem10_average_instrument_reading }}" readonly autofocus autocomplete="chem10_average_instrument_reading">
        </div>
