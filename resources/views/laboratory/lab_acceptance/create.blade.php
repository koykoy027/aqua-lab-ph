                ...
                <div class="mb-3">
                    ...
                    <div class="flex items-center mb-4">
                        <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                            id="complies_with_the_requirement" name="sample_condition" type="checkbox"
                    ...
                    <div class="flex items-center mb-4">
                        <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                            id="leaking_or_with_wet_caps" name="sample_condition" type="checkbox"
                            value="Leaking of with wet caps">
                        <label class="ml-2 text-sm font-medium text-gray-900" for="leaking_or_with_wet_caps">Leaking of
                            with
                            wet caps</label>
                    </div>
                    <div class="flex items-center mb-4">
                        <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                            id="in_another_container" name="sample_condition" type="checkbox"
                    ...
                    <div class="flex items-center mb-4">
                        <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                            id="below_required_volume" name="sample_condition" type="checkbox"
                    ...
                    <div class="flex items-center mb-4">
                        <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                            id="expired" name="sample_condition" type="checkbox" value="Expired">
