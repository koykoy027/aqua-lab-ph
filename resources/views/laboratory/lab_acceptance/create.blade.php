...
<div class="mb-3 bg-white card">
    ...
    <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-3">
        <div class="mb-3">
            ...
            <input id="collector_name" type="text" name="collector_name" value="{{ $requests->collector_name }}"
                disabled autofocus autocomplete="collector_name">
        </div>
        <div class="mb-3">
    ...
    <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
        ...
        <div class="mb-3">
            ...
            <textarea id="sampling_location_address_others" rows="4" name="sampling_location_address_others" disabled
                autofocus autocomplete="sampling_location_address_others"
                readonly>{{ $requests->sampling_location_address_others }}</textarea>
        </div>
    ...
    <div class="mb-3 bg-white card">
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-3">
            <div class="mb-3">
                ...
                <input autocomplete="evaluated_by" autofocus id="evaluated_by" name="evaluated_by" required type="text"
                    value="{{ $acceptance->evaluated_by }}">
                @error('evaluated_by')
            ...
            <div class="mb-3">
                ...
                <input autocomplete="date_evaluated" autofocus id="date_evaluated" name="date_evaluated" required
                    type="date" value="{{ $acceptance->date_evaluated }}">
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-3">
            <div class="mb-3">
                ...
                <div class="flex items-center mb-4">
                    <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                        id="{{ $data }}" name="sample_condition[]" type="checkbox" value="{{ $data }}" {{
            ...
            <div class="mb-3">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex items-center mr-4">
                        <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500"
                            id="remarksConditionallyAccepted" name="remarks" type="radio" value="Conditionally Accepted"
                            onchange="test(this.value)" {{ $acceptance->remarks === 'Conditionally Accepted' ? 'checked'
                        : '' }}>
