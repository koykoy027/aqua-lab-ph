    ...
    <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
        @foreach ($phys1 as $phys1s)
            <div class="mb-3">
                ...
                <select id="phys1_observation" type="number" step="any" name="phys1_observation" value="{{ $phys1s->phys1_observation }}" required autofocus autocomplete="phys1_observation" onchange="phy1()">
