    ...
    <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
        @foreach ($chem7 as $chem7s)
            <div class="mb-3">
                ...
                <input id="chem7_instrument_reading_1" type="number" step="any" name="chem7_instrument_reading_1" value="{{ $chem7s->chem7_instrument_reading_1 }}" required autofocus autocomplete="chem7_instrument_reading_1" onclick="chem7()">
            ...
            <div class="mb-3">
                ...
                <input id="chem7_instrument_reading_2" type="number" step="any" name="chem7_instrument_reading_2" value="{{ $chem7s->chem7_instrument_reading_2 }}" required autofocus autocomplete="chem7_instrument_reading_2" onclick="chem7()">
            ...
            <div class="mb-3">
                ...
                <input id="chem7_instrument_reading_3" type="number" step="any" name="chem7_instrument_reading_3" value="{{ $chem7s->chem7_instrument_reading_3 }}" required autofocus autocomplete="chem7_instrument_reading_3" onclick="chem7()">
            ...
            <div class="mb-3">
                ...
                <input id="chem7_final_result" type="number" step="any" name="chem7_final_result" value="{{ $chem7s->chem7_final_result }}" required autofocus autocomplete="chem7_final_result" onclick="chem7()">
