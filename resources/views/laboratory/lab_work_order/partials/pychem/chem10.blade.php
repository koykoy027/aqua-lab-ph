<div class="mb-3 bg-white card">
    ...
    <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
        <div class="mb-3">
            ...
            <input id="chem10_instrument_reading_1" type="number" step="any" name="chem10_instrument_reading_1" value="{{ $rawDataFileValue->chem10_instrument_reading_1 }}" required autofocus autocomplete="chem10_instrument_reading_1" onchange="chem10()">
        ...
        <div class="mb-3">
            ...
            <input id="chem10_instrument_reading_2" type="number" step="any" name="chem10_instrument_reading_2" value="{{ $rawDataFileValue->chem10_instrument_reading_2 }}" required autofocus autocomplete="chem10_instrument_reading_2" onchange="chem10()">
        ...
        <div class="mb-3">
            ...
            <input id="chem10_instrument_reading_3" type="number" step="any" name="chem10_instrument_reading_3" value="{{ $rawDataFileValue->chem10_instrument_reading_3 }}" required autofocus autocomplete="chem10_instrument_reading_3" onchange="chem10()">
        ...
        <div class="mb-3">
            ...
            <input id="chem10_final_result" type="number" step="any" name="chem10_final_result" value="{{ $rawDataFileValue->chem10_final_result }}" required autofocus autocomplete="chem10_final_result" onchange="chem10()">
