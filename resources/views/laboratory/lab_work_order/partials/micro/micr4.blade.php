    ...
    <div class="card mb-3 bg-white">
        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            <div class="mb-3">
                ...
                <select id="micr4_color_of_the_sample" type="number" name="micr4_color_of_the_sample" value="{{ old('micr4_color_of_the_sample') }}" required autofocus
            ...
            <div class="mb-3">
                ...
                <select id="micr4_fluorescence" type="number" name="micr4_fluorescence" value="{{ old('micr4_fluorescence') }}" required
                    autofocus autocomplete="micr4_fluorescence">
            ...
            <div class="mb-3">
                ...
                <select id="micr4_final_result" type="text" name="micr4_final_result" value="{{ old('micr4_final_result') }}" required
                    autofocus autocomplete="micr4_final_result">
                    <option value="Fluorescence">Fluorescence</option>
                    <option value="Non-Fluorescence">Non-Fluorescence</option>
            </select>
