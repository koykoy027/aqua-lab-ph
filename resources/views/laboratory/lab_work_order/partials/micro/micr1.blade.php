<form action="route('laboratory.lab-work-order-form.micro1', ['analysis_id' => $analysisId])" method="POST">
    @csrf
    {{-- <input id="analysis_id" type="text" name="analysis_id" value="{{ $analysis_id }}" required autofocus autocomplete="analysis_id"> --}}
    ...
    <div class="card mb-3 bg-white">
        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            <div class="mb-3">
                ...
                <input id="micr1_hpc_plate_a" type="number" name="micr1_hpc_plate_a" value="{{ old('micr1_hpc_plate_a') }}"
                    required autofocus autocomplete="micr1_hpc_plate_a" onchange="micro1()">
            ...
            <div class="mb-3">
                ...
                <input id="micr1_hpc_plate_b" type="number" name="micr1_hpc_plate_b"
                    value="{{ old('micr1_hpc_plate_b') }}" required autofocus autocomplete="micr1_hpc_plate_b" onchange="micro1()">
