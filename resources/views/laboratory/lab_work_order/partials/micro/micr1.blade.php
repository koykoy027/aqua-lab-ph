            ...
            @foreach ($micro1 as $micro1s)
                ...
                <div class="mb-3">
                    ...
                    <input id="micr1_hpc_average" type="text" name="micr1_hpc_average"
                        value="{{ $micro1s->micr1_hpc_average }}" required autofocus autocomplete="micr1_hpc_average" readonly>
                ...
                <div class="mb-3">
                    ...
                    <input id="micr1_hpc_final_result" type="text" name="micr1_hpc_final_result"
                        value="{{ $micro1s->micr1_hpc_final_result }}" required autofocus autocomplete="micr1_hpc_final_result"
                        readonly>
