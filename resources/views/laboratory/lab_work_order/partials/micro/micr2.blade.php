<form action="{{ route('laboratory.lab-work-order-form.micro2', ['analysis_id' => $requests->analysis_id]) }}"
    method="POST">
    @csrf
    ...
    <div class="mb-3 bg-white card">
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
            <div class="mb-3">
                ...
                <input id="micr2_tc_24" type="number" step="any" name="micr2_tc_24"
                    value="{{ $rawDataFileValue->micr2_tc_24 }}" required autofocus autocomplete="micr2_tc_24"
                    onchange="micro2()">
                @error('micr2_tc_24')
            ...
            <div class="mb-3">
                ...
                <input id="micr2_tc_48" type="number" step="any" name="micr2_tc_48"
                    value="{{ $rawDataFileValue->micr2_tc_48 }}" required autofocus autocomplete="micr2_tc_48"
                    onchange="micro2()">
                @error('micr2_tc_48')
                    <span class="invalid" role="alert">
                        <strong>{{ $message }}</strong>
            ...
            <div class="mb-3">
                ...
                <input id="micr2_tc_final_result" type="text" name="micr2_tc_final_result"
                    value="{{ $rawDataFileValue->micr2_tc_final_result }}" required autofocus
            ...
            <div class="mb-3">
                ...
                <input id="micr2_tc_remarks" type="text" name="micr2_tc_remarks"
                    value="{{ $rawDataFileValue->micr2_tc_remarks }}" required autofocus autocomplete="micr2_tc_remarks"
                    readonly>
