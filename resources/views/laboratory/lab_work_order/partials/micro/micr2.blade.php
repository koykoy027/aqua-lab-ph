<div class="mb-3 bg-white card">
    ...
    <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
        ...
        <div class="mb-3">
            ...
            <input id="micr2_tc_48" type="number" step="any" name="micr2_tc_48" value="{{ $micro2s->micr2_tc_48 }}"
                required autofocus autocomplete="micr2_tc_48" onchange="micro2()">
            @error('micr2_tc_48')
            <span class="invalid" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="mb-3">
            ...
            <input id="micr2_tc_remarks" type="text" name="micr2_tc_remarks" value="{{ $micro2s->micr2_tc_remarks }}"
