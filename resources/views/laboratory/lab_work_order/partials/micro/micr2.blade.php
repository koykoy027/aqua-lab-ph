        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
            @foreach ($micro2 as $micro2s)
                <div class="mb-3">
                    ...
                    <input id="micr2_tc_24" type="number" step="any" name="micr2_tc_24" value="{{ $micro2s->micr2_tc_24 }}" required
                ...
                <div class="mb-3">
                    ...
                    <input id="micr2_tc_48" type="number" step="any" name="micr2_tc_48" value="{{ $micro2s->micr2_tc_48 }}" required
                ...
                <div class="mb-3">
                    ...
                    <input id="micr2_tc_final_result" type="text" name="micr2_tc_final_result"
                        value="{{ $micro2s->micr2_tc_final_result }}" required autofocus autocomplete="micr2_tc_final_result"
                        readonly>
                ...
                <div class="mb-3">
                    ...
                    <input id="micr2_tc_remarks" type="text" name="micr2_tc_remarks"
                        value="{{ $micro2s->micr2_tc_remarks }}" required autofocus autocomplete="micr2_tc_remarks" readonly>
