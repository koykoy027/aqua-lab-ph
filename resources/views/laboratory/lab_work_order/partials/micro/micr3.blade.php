<form action="{{ route('laboratory.lab-work-order-form.micro3', ['analysis_id' => $requests->analysis_id]) }}"
    method="POST">
    @csrf
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
            <div class="mb-3">
                ...
                <input id="micr3_lauryl_24" type="number" step="any" name="micr3_lauryl_24"
                    value="{{ $rawDataFileValue->micr3_lauryl_24 }}" required autofocus autocomplete="micr3_lauryl_24">
            ...
            <div class="mb-3">
                ...
                <input id="micr3_lauryl_48" type="number" step="any" name="micr3_lauryl_48"
                    value="{{ $rawDataFileValue->micr3_lauryl_48 }}" required autofocus autocomplete="micr3_lauryl_48">
            ...
            <div class="mb-3">
                ...
                <input id="micr3_brillant_24" type="number" step="any" name="micr3_brillant_24"
                    value="{{ $rawDataFileValue->micr3_brillant_24 }}" required autofocus
                    autocomplete="micr3_brillant_24" onchange="micro3()">
            ...
            <div class="mb-3">
                ...
                <input id="micr3_brillant_48" type="number" step="any" name="micr3_brillant_48"
                    value="{{ $rawDataFileValue->micr3_brillant_48 }}" required autofocus
                    autocomplete="micr3_brillant_48" onchange="micro3()">
            ...
            <div class="mb-3">
                ...
                <input id="micr3_final_result" type="text" name="micr3_final_result"
                    value="{{ $rawDataFileValue->micr3_final_result }}" required autofocus
            ...
            <div class="mb-3">
                ...
                <input id="micr3_remarks" type="text" name="micr3_remarks"
                    value="{{ $rawDataFileValue->micr3_remarks }}" required autofocus autocomplete="micr3_remarks"
                    readonly>
                @error('micr3_remarks')
                    <span class="invalid" role="alert">
                        <strong>{{ $message }}</strong>
