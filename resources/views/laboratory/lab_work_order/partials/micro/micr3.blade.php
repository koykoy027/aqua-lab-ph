        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            ...
            <div class="mb-3">
                ...
                <input id="micr3_lauryl_48" type="number" name="micr3_lauryl_48" value="{{ old('micr3_lauryl_48') }}" required
                    autofocus autocomplete="micr3_lauryl_48">
            ...
            <div class="mb-3">
                ...
                <input id="micr3_brillant_24" type="text" name="micr3_brillant_24" value="{{ old('micr3_brillant_24') }}" required
                    autofocus autocomplete="micr3_brillant_24" readonly>
            ...
            <div class="mb-3">
                ...
                <input id="micr3_brillant_48" type="text" name="micr3_brillant_48" value="{{ old('micr3_brillant_48') }}"
                    required autofocus autocomplete="micr3_brillant_48" readonly>
