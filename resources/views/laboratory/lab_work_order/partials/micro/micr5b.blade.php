{{-- same as micr1 --}}
<input type="hidden" value="{{ $rawDataFile->water_purpose }}" name="water_purpose">
    ...
    <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
        <div class="mb-3">
            ...
            <input id="micr5b_hpc_plate_a" type="number" step="any" min="0" max="100000" name="micr5b_hpc_plate_a"
                value="{{ $micro5b->micr5b_hpc_plate_a }}" required autofocus autocomplete="micr5b_hpc_plate_a"
                onchange="micro5b()">
        ...
        <div class="mb-3">
            ...
            <input id="micr5b_hpc_plate_b" type="number" step="any" min="0" max="100000" name="micr5b_hpc_plate_b"
                value="{{ $micro5b->micr5b_hpc_plate_b }}" required autofocus autocomplete="micr5b_hpc_plate_b"
                onchange="micro5b()">
        ...
        <div class="mb-3">
            ...
            <input id="micr5b_hpc_average" type="text" name="micr5b_hpc_average" value="{{ $micro5b->micr5b_hpc_average }}"
                required autofocus autocomplete="micr5b_hpc_average" readonly>
    ...
    <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
        <div class="mb-3">
            ...
            <input id="micr5b_no_of_yellow_wells_rxn_after_18h" type="number" step="any" min="0" max="100000"
                ...
                required autofocus autocomplete="micr5b_no_of_yellow_wells_rxn_after_18h">
    ...
    <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
        <div class="mb-3">
            ...
            <input id="micr5b_no_of_yellow_flourescent_wells_rxn_after_18hr" type="number" step="any" min="0" max="100000"
                ...
                required autofocus autocomplete="micr5b_no_of_yellow_flourescent_wells_rxn_after_18hr">
