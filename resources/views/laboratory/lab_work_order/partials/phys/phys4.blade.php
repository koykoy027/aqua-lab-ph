    ...
    <div class="card mb-3 bg-white">
        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            <div class="mb-3">
                ...
                <input id="phys4_instrument_reading_1" type="number" name="phys4_instrument_reading_1" value="{{ $rawDataFileValue->phys4_instrument_reading_1 }}" required autofocus autocomplete="phys4_instrument_reading_1" onchange="phy4()">
            ...
            <div class="mb-3">
                ...
                <input id="phys4_instrument_reading_2" type="number" name="phys4_instrument_reading_2" value="{{ $rawDataFileValue->phys4_instrument_reading_2 }}" required autofocus autocomplete="phys4_instrument_reading_2" onchange="phy4()">
            ...
            <div class="mb-3">
                ...
                <input id="phys4_instrument_reading_3" type="number" name="phys4_instrument_reading_3" value="{{ $rawDataFileValue->phys4_instrument_reading_3 }}" required autofocus autocomplete="phys4_instrument_reading_3" onchange="phy4()">
            ...
            <div class="mb-3">
                ...
                <input id="phys4_final_result" type="number" name="phys4_final_result" value="{{ $rawDataFileValue->phys4_final_result }}" required autofocus autocomplete="phys4_final_result" onchange="phy4()">
