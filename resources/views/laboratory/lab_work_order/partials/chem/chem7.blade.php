    ...
    <div class="card mb-3 bg-white">
        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            <div class="mb-3">
                ...
                <input id="chem7_instrument_reading_1" type="number" name="chem7_instrument_reading_1" value="{{ $rawDataFileValue->chem7_instrument_reading_1 }}" required autofocus autocomplete="chem7_instrument_reading_1">
            ...
            <div class="mb-3">
                ...
                <input id="chem7_instrument_reading_2" type="number" name="chem7_instrument_reading_2" value="{{ $rawDataFileValue->chem7_instrument_reading_2 }}" required autofocus autocomplete="chem7_instrument_reading_2">
            ...
            <div class="mb-3">
                ...
                <input id="chem7_instrument_reading_3" type="number" name="chem7_instrument_reading_3" value="{{ $rawDataFileValue->chem7_instrument_reading_3 }}" required autofocus autocomplete="chem7_instrument_reading_3">
            ...
            <div class="mb-3">
                ...
                <input id="chem7_final_result" type="number" name="chem7_final_result" value="{{ $rawDataFileValue->chem7_final_result }}" required autofocus autocomplete="chem7_final_result">
