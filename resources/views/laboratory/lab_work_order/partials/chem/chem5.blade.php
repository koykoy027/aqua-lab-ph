    ...
    <div class="card mb-3 bg-white">
        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            ...
            <div class="mb-3">
                ...
                <input id="chem5_final_result" type="number" name="chem5_final_result" value="{{ $rawDataFileValue->chem5_final_result }}" required autofocus autocomplete="chem5_final_result">
