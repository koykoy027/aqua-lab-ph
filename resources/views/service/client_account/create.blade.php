    ...
    <div class="mb-3 bg-white card">
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
            <div class="mb-3">
                ...
                <input id="client_id" type="text" name="client_id" value="" required autofocus autocomplete="client_id"
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
            ...
            <div class="mb-3">
                ...
                <input id="name_of_owner" type="text" name="name_of_owner" value="{{ old('name_of_owner') }}" required
                    autofocus autocomplete="name_of_owner">
                @error('name_of_owner')
                <span class="invalid" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
    ...
    <div class="bg-white card">
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-3">
            ...
            <div class="mb-3">
                ...
                <select id="api_region" type="text" name="api_region" required autofocus autocomplete="api_region">
            ...
            <div class="mb-3">
                ...
                <select id="api_province" type="text" name="api_province" required autofocus
                    autocomplete="api_province">
            ...
            <div class="mb-3">
                ...
                <select id="api_barangay" type="text" name="api_barangay" required autofocus
    ...
    <div class="bg-white card">
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-3">
            ...
            <div class="mb-3">
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" autofocus autocomplete="email">
                @error('email')
                <span class="invalid" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-3">
            <div class="mb-3">
                ...
                <input id="contact_person1_name" name="contact_person1_name" value="{{ old('contact_person1_name') }}"
                    autofocus autocomplete="contact_person1_name">
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-3">
            <div class="mb-3">
                ...
                <input id="contact_person2_name" name="contact_person2_name" value="{{ old('contact_person2_name') }}"
                    autofocus autocomplete="contact_person2_name">
    ...
    <div class="bg-white card">
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-3">
            <div class="mb-3">
                ...
                <input id="fsr_assigned" type="text" name="fsr_assigned" value="{{ old('fsr_assigned') }}" required
                    autofocus autocomplete="fsr_assigned">
                @error('fsr_assigned')
                <span class="invalid" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="mb-3">
                ...
                <select name="market_segment" id="market_segment" value="{{ old('market_segment') }}" required autofocus
                    autocomplete="market_segment" onchange="marketSegment(this.value)">
            ...
            <div class="mb-3">
                ...
                <input id="market_segment_others" type="text" name="market_segment_others"
                    value="{{ old('market_segment_others') }}" required autofocus autocomplete="market_segment_others"
                    readonly>
        ...
        <div class="grid gap-4 sm:gid-cols-1 lg:grid-cols-2">
            <div class="mb-3">
                ...
                <select name="assigned_week" id="assigned_week" value="{{ old('assigned_week') }}" required autofocus
                    autocomplete="assigned_week">
