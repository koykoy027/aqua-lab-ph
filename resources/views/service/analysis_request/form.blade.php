...
<div class="card mb-3 bg-white">
    ...
    <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-3">
        ...
        <div class="mb-3">
            ...
            <input id="municipality_or_city" type="text" name="municipality_or_city" value="{{ $clients->municipality_or_city }}" readonly>
        </div>
        <div class="mb-3">
    ...
    <div class="card mb-3 bg-white">
        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            ...
            <div class="mb-3">
                ...
                <input id="collection_point_others" type="text" name="collection_point_others" value="{{ old('collection_point_others') }}" required autofocus autocomplete="collection_point_others" readonly>
    ...
    <div class="card mb-3 bg-white">
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            ...
            <div class="mb-3">
                ...
                <input id="source_of_water_sample_others" type="text" name="source_of_water_sample_others" value="{{ old('source_of_water_sample_others') }}" required autofocus autocomplete="source_of_water_sample_others" readonly>
        ...
        <div class="sm:gid-cols-1 grid gap-4 lg:grid-cols-2">
            ...
            <div class="mb-3">
                ...
                <input id="water_purpose_others" type="text" name="water_purpose_others" value="{{ old('water_purpose_others') }}" required autofocus autocomplete="water_purpose_others" readonly>
